...
import com.atec.learning.classification.service.BayesClassifier;
import com.atec.learning.classification.service.RdrClassification;
import com.atec.learning.classification.service.RdrClassificationUtils;
...
public class BayesClassifierTest {
	...
	private RdrClassificationUtils<String, String> bayes;
	...
	public void testStringClassificationInDetails() {
		...
		Collection<RdrClassification<String, String>> classifications = ((BayesClassifier<String, String>) bayes).classifyDetailed(
                Arrays.asList(unknownText1));
		
		List<RdrClassification<String, String>> list = new ArrayList<RdrClassification<String,String>>(classifications);
