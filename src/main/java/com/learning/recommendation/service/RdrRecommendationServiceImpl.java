...
import com.atec.learning.track.service.UserTrackServiceImpl;

public class RdrRecommendationServiceImpl implements RdrRecommendationService{

	@Value("${recommendation.items}")
	public final static int nb_recommendationItems=2;
	
	@Value("${recommendation.neighboorhood}")
	public final static int nb_recommendationneighborhood=10;
